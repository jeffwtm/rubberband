...
(async () => {
    ...
    try {
        await sh.connect();
        await sh.download("/Users/jeffsmith/Projects/incominggames/build/notarized/Shadow_of_Aya-steam.zip", "D:\\Dev Projects\\shadow of aya\\build\\macOS\\1.0.51\\Shadow_of_Aya-steam.zip");
    }
    finally {
        await sh.close();
    }
